...
# Create model paths using os.path.join for better path handling
...
breast_cancer_model_path = os.path.join(working_dir, 'saved_models', 'b_cancer.sav')
...
if selected == 'Breast Cancer Predection':

    st.title("Breast Cancer Prediction using ML")

    # Input features based on dataset
 ...
 'worst compactness', 'worst concavity', 'worst concave points', 'worst symmetry', 'worst fractal dimension']
    ...
    for idx, feature in enumerate(feature_names):
        ...
        value = col.text_input(f"{feature.replace('_', ' ').title()}")
    ...
    if st.button("Breast Cancer Test Result"):
        try:
            ...
            cancer_diagnosis = "Please enter valid numeric values in all fields."
